...
class Captcha:
    ...
    def __params(self):
        # 'fp=verify_lvuymi8m_SqLyXCDa_pBd6_4luh_BRvh_xIDmdELcyZnL
        # &type=verify
        # &detail=2fX7c6No3jlYEbNYNfqUkMvB8B3FSEvhcua7IpFrT4KDaLTGu1HaRkKpW5omHYH7jYT8hO-A3ZXZWDBx4HsIAAxcFabpkvSpdC5g19pkemI4fbly-5LHaYwOwOzpqfg7KwI0lkFO8NRAX5F-mQTG2BcNA2UfIaGbhr1nEniTDBFkqAJarEK9q0z5FsLxylvnwb-op4LUeBdjH*A4lB4IcBJRevFtJcDVUyHlAPdy*N2Jlp242c348q-0ToKXWipKtQpuPHEkyZ0Ga5qFeLtakgE-UkF1yEbwiuOCr47qzkH-Z9AhE3UUr9VXeF6yHu8lvy1XMYnRh2JB19R1V*KHQvbbIdlldsXLaixlyuhJLZKqCuIKN6z39BIwqiyLp49L-fi4pvK1f06-u6XbPw..
        # &challenge_code=3058
        # &os_name=windows
        # &h5_check_version=3.8.19
        # &region=in
        # &triggered_region=in
        # &cookie_enabled=true
        # &screen_width=1280
        ...
        # &browser_version=5.0+(Windows+NT+10.0%3B+Win64%3B+x64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F123.0.6312.4+Safari%2F537.36
        # &msToken=4DfUjQe0p1ColM3guPSx_boPUIXhqpdmdQSvfW_cK4esXmI0rXUOS_EV37H6qIP7SM23fSPIJiaycbk3dnfBuHGXBK2gdIbq8CTkd4fMc-M6PdEqikXm0oPV7m8-&X-Bogus=DFSzKwVOvOtANHOGtRjI3NQrmsdP
        # &_signature=_02B4Z6wo00001ZGAO6AAAIDCLT17E7licAWRoD8AAAJZfc'
        params = {
            'lang': 'en',
            'app_name': '',
            'h5_sdk_version': '2.33.2',
            'h5_sdk_use_type': 'cdn',
            'sdk_version': '3.8.19',
            'iid': self.params['iid'],
    ...
    def __get_challenge(self):
        ...
        return self.__client.get(f'https://{self.domain}.tiktok.com/captcha/get?{params}',
